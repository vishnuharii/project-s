...
let fetAllStylerFn = async (obj) => {
  try {
    let req = await fetch(
      "https://salon-back-3o7b.onrender.com/stylist/styler",
      {
        method: "GET",
        headers: {
...
let availablilityCheckerFunction = (obj) => {
  fetch("https://salon-back-3o7b.onrender.com/appointments/appointment", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
    },
...
async function createAppointmentFunction(obj) {
  try {
    let add_req = await fetch(
      `https://salon-back-3o7b.onrender.com/appointments/appointment/add`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
